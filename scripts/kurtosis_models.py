...
def rekindle(datafile,bvecfile,bvalfile,mask,parameters_file):
    ...
    bvals, bvecs = dipy.io.read_bvals_bvecs(bvalfile, bvecfile)
...
def IRL1SHORE(datafile,bvecfile,bvalfile,mask,parameters_file):
    config = configparser.ConfigParser()
    config.read(parameters_file)
...
def relSHORE(datafile,bvecfile,bvalfile,mask,parameters_file):
    config = configparser.ConfigParser()
    config.read(parameters_file)
...
def kurtosis(datafile,bvecfile,bvalfile,model,mask=None, parameters_file='parameters.ini'):
    if model == 'REKINDLE':
        return rekindle(datafile,bvecfile,bvalfile,mask,parameters_file)
    elif model == 'IRL1SHORE':
        return IRL1SHORE(datafile,bvecfile,bvalfile,mask,parameters_file)
    elif model == 'relSHORE':
        return relSHORE(datafile,bvecfile,bvalfile,mask,parameters_file)
    else:
