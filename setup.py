...
requirements = ['nibabel', 'numpy', 'dipy', 'scipy', 'tqdm', 'cvxopt', 'sklearn']
...
setup(
    ...
    package_dir={'': 'src'},
    scripts=['scripts/mtdeconv', 'scripts/kurtosis/kurtosis-cone.py', 'scripts/kurtosis/kurtosis-measures.py', 'scripts/correct_dropouts.py'],
