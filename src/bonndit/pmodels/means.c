  ...
  { /* enter inner scope */
    ...
    for (;;) {
      ...
      { /* enter inner scope */
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_12 = __Pyx_PyObject_GetSlice(__pyx_t_2, 0, 0, NULL, &__pyx_8genexpr2__pyx_v_7bonndit_7pmodels_5means_x, NULL, 0, 0, 0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 14, __pyx_L31_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
