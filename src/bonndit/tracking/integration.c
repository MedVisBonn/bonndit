 ...
 * 
 */
  if (unlikely(!__pyx_v_self->__pyx_base.three_vector.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");__PYX_ERR(1, 59, __pyx_L1_error)}
 ...
 * cdef class EulerUKF(Integration):
 */
  if (unlikely(!__pyx_v_self->__pyx_base.trafo->point_wtoi.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");__PYX_ERR(1, 60, __pyx_L1_error)}
 ...
 * 
 */
  if (unlikely(!__pyx_v_self->__pyx_base.three_vector.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");__PYX_ERR(1, 76, __pyx_L1_error)}
  __pyx_t_1 = __pyx_f_7bonndit_5utilc_14cython_helpers_norm(__pyx_v_direction);
  if (unlikely(__pyx_t_1 == 0)) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
